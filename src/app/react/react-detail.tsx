...
class ReactDetail extends React.Component<IReactBidirectionalProduct, any> {
  ...
  render() {
    const descriptionRender = this.state.details.description;
    const contentRender = this.state.details.content;
    let descriptionHTML = <></>;
    let contentHTML = <></>;
    if (descriptionRender != "" && descriptionRender != null && descriptionRender != "<p><br></p>") {
      descriptionHTML = (
        <>
          <p>
          ...
          <HTMLComponent rawHTML={descriptionRender} />
        </>
      );
    }
    if (descriptionRender != "" && descriptionRender != null && descriptionRender != "<p><br></p>") {
      contentHTML = (
        <>
          ...
          <div className="message-content">
            <HTMLComponent rawHTML={contentRender} />
          </div>
        </>
      );
    }
